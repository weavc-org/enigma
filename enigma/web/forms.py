...
class m3_form(FlaskForm):
    ...
    data = wtforms.TextAreaField(
        'Data', [wtforms.validators.DataRequired(message='Required')])
    ...
    left_rotor_setting = wtforms.SelectField(
        "A", choices=list("ABCDEFGHIJKLMNOPQRSTUVWXYZ"))
    middle_rotor_setting = wtforms.SelectField(
        "A", choices=list("ABCDEFGHIJKLMNOPQRSTUVWXYZ"))
    right_rotor_setting = wtforms.SelectField(
        "A", choices=list("ABCDEFGHIJKLMNOPQRSTUVWXYZ"))

    left_ring_setting = wtforms.SelectField(
        "A", choices=list("ABCDEFGHIJKLMNOPQRSTUVWXYZ"))
    middle_ring_setting = wtforms.SelectField(
        "A", choices=list("ABCDEFGHIJKLMNOPQRSTUVWXYZ"))
    right_ring_setting = wtforms.SelectField(
        "A", choices=list("ABCDEFGHIJKLMNOPQRSTUVWXYZ"))
